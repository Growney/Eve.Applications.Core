...
namespace Eve.EveAuthTool.GUI.Web.Models.Search
{
    public class SearchResult
    {
        ...
        public SearchResult(PublicDataProvider dataProvider, SearchResults results,bool oldData, string resultID)
        {
            ResultID = resultID;
            ...
            Factions = new LazyLoadedList<long, ChrFactions>(x => dataProvider.Cache.GetItemAsync<ChrFactions>((int)x),results.Faction);
        }
